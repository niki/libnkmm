...
// Alias
typedef nkmm::Lisp Lisp;

typedef nkmm::Int LispInt;      //!< Int型
typedef nkmm::Float LispFloat;  //!< Float型
typedef nkmm::Bool LispBool;    //!< Bool型
typedef nkmm::Ptr LispPtr;      //!< ポインター型
typedef nkmm::Str LispStr;      //!< 文字列型

typedef nkmm::Var LispVar;
typedef nkmm::Lisp::Vars LispVars;
typedef nkmm::Lisp::Funcs LispFuncs;
typedef nkmm::Lisp::Args LispArgs;
