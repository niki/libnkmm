...
//#define NKMM_R_TYPE       int32_t
#define NKMM_R_TYPE int64_t
#define NKMM_R_TYPE_SIZE sizeof(NKMM_R_TYPE)
...
int Memory::Compare(void* A, void* B, int size) {
  NKMM_R_TYPE* a1 = (NKMM_R_TYPE*)A;
  NKMM_R_TYPE* b1 = (NKMM_R_TYPE*)B;

  // KX_R_TYPE 単位で処理
  while (NKMM_R_TYPE_SIZE <= size) {
    size -= NKMM_R_TYPE_SIZE;
