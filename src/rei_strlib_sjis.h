...
//====================================================================
#ifndef REI_STR_SJIS_H
#define REI_STR_SJIS_H

//2008.08.29 rei::Search*String*()で 1文字検索がうまくいかない模様
...
char* CopyChar(char* dst, const char* src, int num);  // rei::strcpy（文字単位）
