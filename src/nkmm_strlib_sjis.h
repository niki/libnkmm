...
#ifndef NKMM_STR_SJIS_H
#define NKMM_STR_SJIS_H

//2008.08.29 nkmm::Search*String*()で 1文字検索がうまくいかない模様
...
char* CopyChar(char* dst, const char* src, int num);  // nkmm::strcpy（文字単位）
