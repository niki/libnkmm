...
// 数値を文字列に変換
#ifdef NCRT
#define MCR_atoi(x) rei::math::StrToInt(x)
#define MCR_itoa(x, dest, radix) rei::math::IntToStr(x, dest, (radix) == 10 ? NULL : "0x")
#define MCR_atof(x) rei::math::StrToFloat(x)
#else
#include <stdlib.h>
#include <math.h>
...
#define MCR_ftoa(x, dest) rei::math::FloatToStr(x, dest, 0)
